...
/* TODO: ACTIVAR ESTA FUNCION PARA HACER UN PRINTF */
//extern void vOutputChar( const char cChar, const TickType_t xTicksToWait  );
/*INFO: La funcion xTicksToWait tiene comentado la palabra reservada static*/
/*static*/
...
/*INFO: La funcion i2hex tiene comentado la palabra reservada static y la palabra portINLINE*/
/*static portINLINE*/
int i2hex( int aCh )
{
int iResult;
...
static BaseType_t prints(struct SStringBuf *apBuf, const char *apString )
{
  ...
  /* TODO:  ver como implementar esta funcion
